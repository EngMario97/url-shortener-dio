...
declare type TypegooseDoc<T> = T & MongooseDocumentMiddleware;
...
export declare const pre: {
    ...
    <T_1>(method: RegExp | "init" | "validate" | "save" | "remove", parallel: boolean, fn: DocumentPreParallelFn<T_1>): ClassDecorator;
    <T_2>(method: RegExp | "count" | "find" | "findOne" | "findOneAndRemove" | "findOneAndUpdate" | "update" | "updateOne" | "updateMany" | "insertMany", fn: SimplePreSerialFn<T_2>): ClassDecorator;
    <T_3>(method: RegExp | "count" | "find" | "findOne" | "findOneAndRemove" | "findOneAndUpdate" | "update" | "updateOne" | "updateMany" | "insertMany", parallel: boolean, fn: SimplePreParallelFn<T_3>): ClassDecorator;
};
export declare const post: {
    <T>(method: RegExp | "count", fn: PostNumberResponse<T>): ClassDecorator;
    <T_1>(method: RegExp | "count", fn: PostNumberWithError<T_1>): ClassDecorator;
    <T_2>(method: RegExp | "init" | "validate" | "save" | "remove" | "findOne" | "findOneAndRemove" | "findOneAndUpdate", fn: PostSingleResponse<T_2>): ClassDecorator;
    <T_3>(method: RegExp | "init" | "validate" | "save" | "remove" | "findOne" | "findOneAndRemove" | "findOneAndUpdate", fn: PostSingleWithError<T_3>): ClassDecorator;
    <T_4>(method: RegExp | "find" | "update", fn: PostMultipleResponse<T_4>): ClassDecorator;
    <T_5>(method: RegExp | "find" | "update", fn: PostMultipleWithError<T_5>): ClassDecorator;
    <T_6>(method: RegExp | "insertMany", fn: ModelPostFn<T_6> | PostMultipleResponse<T_6>): ClassDecorator;
};
export { };
